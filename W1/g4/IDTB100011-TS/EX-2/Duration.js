...
export class Duration {
    ...
    * If the result is negative, it will returns zero.
    * @param {Duration} other - Another duration to subtract.
    * @returns {Duration} A new Duration representing the result of subtract.
    */
 
   minus = (other) => {
          // YOUR CODE
          const result = Math.max(0, this._totalSeconds - other._totalSeconds);
